...
import com.zstu.edu.components.DynamicPermission;
...
public class WebSecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/student2Controller/get").permitAll()
                .antMatchers(HttpMethod.POST, "/student2Controller/get").permitAll()
                //权限的配置
                //ROLE_ADMIN可以操作任何事情
